(function teacherDashboardVNext() {
  ...
  var el = {
    ...
    meetingSetupSummary: document.getElementById("td-meeting-setup-summary"),
    meetingSetupToggle: document.getElementById("td-meeting-setup-toggle"),
    ...
    meetingExportStrip: document.getElementById("td-meeting-export-strip"),
    meetingActionsStrip: document.getElementById("td-meeting-actions-strip"),
