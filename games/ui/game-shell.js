    ...
    function render() {
      ...
      if (galleryOnly) {
        shell.innerHTML = [
          ...
          '      <h2>Pick a game and go.</h2>',
          '      <p>Fast launch. Clear purpose. One strong routine at a time.</p>',
          '      <div class="cg-gallery-hero__chips"><span class="cg-chip" data-tone="focus">Ready in one click</span><span class="cg-chip">Small-group friendly</span></div>',
          "    </div>",
          '    <div class="cg-gallery-hero__panel">',
          '      <div class="cg-gallery-hero__panel-kicker">Best next move</div>',
          '      <strong>Launch one flagship, then review.</strong>',
          '      <p>Use the filters, pick the clearest fit, and move straight into play.</p>',
          "    </div>",
          "  </section>",
