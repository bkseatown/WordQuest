...
async function getDashboardMarkers(page) {
  return page.evaluate(() => {
    ...
    return {
      ...
      hasStudentDrawer: !!document.getElementById('td-student-drawer') || !!audit.hasStudentDrawer,
      ...
      hasTodayPlan: !!document.getElementById('td-plan-list') || !!audit.hasTodayPlan,
      hasProgressNote: !!document.getElementById('td-progress-note-text') || !!audit.hasProgressNote,
      ...
      hasMeetingNotesTool: !!document.getElementById('td-meeting-workspace') || !!audit.hasMeetingNotesTool,
      hasReferralPacketExport: !!document.getElementById('td-support-export-packet') || !!audit.hasReferralPacketExport,
      hasShareControls: !!document.getElementById('td-share-summary') || !!document.getElementById('td-share-quick-copy') || !!audit.hasShareControls,
